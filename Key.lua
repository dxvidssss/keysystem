...
local Config = {
    ...
    ServiceId       = 24678, -- Your PlatoBoost Service ID
    PlatoSecret     = "812461b0-c84d-4073-bb7a-46f5e4aaf452", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "WeTheBestMusic", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/dxvidssss/keysystem/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    HubName         = "_zqyr.lua", -- The main title shown at the top of the GUI
    HubDescription  = "key" -- The text shown below the title
}
